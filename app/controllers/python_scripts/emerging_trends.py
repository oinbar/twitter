...
latent_factor = 5 # HOW FAR BACK TO START COLLECTING THE CORPUS.  DIRECTLY AFFECTS HOW SOON THE TREND STARTS TO PLATEAU OR DECLINE.
global_corpus_size = 5 # THE TF CORPUS WILL ALWAYS CONTAIN ONE UNIT'S WORTH OF INFORMATION (E.G. ONE HOUR, ONE DAY), THIS WILL DETERMINE HOW MANY UNITS TO USE FOR THE ENTIRE TFIDF CORPUS.  DIRECTLY AFFECTS THE SMOOTHNES OF THE GRAPH AND COMPUTATIONAL RESOURCES.
N = 96 # THE NUMBER OF DATA POINTS TO DISPLAY ON THE GRAPH. 
